...
class ChatBot:
    def __init__(self, api_key: str = None):
        ...
        Если запрос не информативен и содержит только название тикера то в ответе напиши информацию которая состоит из: цена тикера + информация о тикере + краткая выжимка самых актуальных и важных новостей.
        """
        ...
        stock_news_tool = Tool(
            ...
            description=(
                ...
                "Если нужно, сформируй краткую выжимку, оставив только основную и важную информацию."
            )
        )
